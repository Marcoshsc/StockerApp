...
public class CompraDetail extends JFrame {
...
//				dispose();
		...
		for (Debito debito : debitos) {
			Object rowData[] = new Object[nColumns];
			rowData[0] = debito.isPago() ? "" : "Pagar debito";
...
//	}
	 ...
	 * Create the frame.
	 */
	public CompraDetail(Operacao operacao) {
...
//		contentPane.add(scrollPane);
		...
		lblCliente = new JLabel("Fornecedor:");
		...
		lblRaquel = new JLabel(operacao.getFornecedor().getNome());
...
//		lblRaquel.setSize(326, 17);
		...
		JLabel itensLabel = new JLabel("Itens da Compra");
		...
		JButton btnDesfazer = new JButton("Desfazer Compra");
